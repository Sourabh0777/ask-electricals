          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                ASK Electricals Pvt. Ltd. is a dynamic and innovative motor manufacturing company, established in May
                2025 with a vision to power the next generation of air movement technologies.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                We specialize in the design, development, and production of high-performance electric motors tailored
                for air fan coolers, air conditioners, and kitchen chimneys. Our mission is to deliver reliable,
                energy-efficient, and durable motor solutions that meet the growing demands of OEMs and appliance
            ...
            <Card className="border-l-4 border-l-red-600">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700">
                  To become a leading provider of advanced motor solutions that empower cooling and ventilation systems
                  worldwide.
                </p>
              </CardContent>
            </Card>
